...
if(isset($_POST['submit'])){
        ...
        $insert = mysqli_query($conn, "INSERT INTO tb_angkatan_202316 VALUES('', '$angkatan')");
...
<div class="container-fluid">
  ...
  ?>
    ...
    <div class="row">
        <div class="col-lg-12">
           <h3>Form tambah data angkatan</h3>
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="mb-3">
            <input type="number" class="form-control" name="angkatan" placeholder="Angkatan" autofocus id="angkatan">
        </div>
