    ...
    <div class="row">
      <div class="col-lg-8">
        ...
        <table class="table table-sm table-striped table-bordered">
                    ...
                    <?php 
							$no = 1;
							$user = mysqli_query($conn, "SELECT * FROM tb_user_202316");
						...
						<tr>
                            ...
                            <td>
								<a href="detail_user.php?id_user=<?php echo $row['id_user']?>" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i></i></a>
                            </td>				
						</tr>
						<?php }}else{ ?>
							<tr>
